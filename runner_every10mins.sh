...
python "$CODE_PATH"/gen_ww_stockholm_logyaxis.py > "$CODE_PATH"/output/wastewater_combined_stockholm.json
python "$CODE_PATH"/gen_ww_stockholm_regular.py > "$CODE_PATH"/output/wastewater_stockholm_logyaxis.json
