...
PYTHONPATH="$CODE_PATH"/covid-portal-visualisations/wastewater python "$CODE_PATH"/covid-portal-visualisations/wastewater/quant_malmö_kthplot.py > "$CODE_PATH"/output/wastewater_kthmalmö.json
